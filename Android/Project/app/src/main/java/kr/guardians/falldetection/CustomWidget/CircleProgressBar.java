...
public class CircleProgressBar extends View {
   ...
   public void setProgress(float progress) {
       if(progress <= 30){
           setColor(getResources().getColor(R.color.blueProgress,null));
        }else if(progress <= 50){
           setColor(getResources().getColor(R.color.yellowProgress,null));
       }else{
            setColor(getResources().getColor(R.color.redProgress,null));
        }
